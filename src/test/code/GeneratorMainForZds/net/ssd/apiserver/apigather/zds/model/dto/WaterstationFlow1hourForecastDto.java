 ...
 * @since 2021-03-08
 */
@TableName("WaterStation_Flow_1Hour_Forecast")
@ApiModel(value="WaterstationFlow1hourForecast对象", description="")
public class WaterstationFlow1hourForecastDto implements Serializable{
    ...
    public String toString() {
        return "WaterstationFlow1hourForecast{" +
        "ldate=" + ldate +
        ", ltime=" + ltime +
        ", b1=" + b1 +
        ", b2=" + b2 +
