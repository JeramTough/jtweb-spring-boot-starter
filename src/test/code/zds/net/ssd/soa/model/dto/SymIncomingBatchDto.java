 ...
 * @since 2021-09-08
 */
@ApiModel(value="SymIncomingBatch对象", description="")
public class SymIncomingBatchDto implements Serializable{
    ...
    public Integer getFailedLineNumber() {
        return failedLineNumber;
    }

    public void setFailedLineNumber(Integer failedLineNumber) {
