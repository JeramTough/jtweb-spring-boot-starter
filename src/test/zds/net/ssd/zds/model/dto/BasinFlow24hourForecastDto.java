 ...
 * @since 2021-04-25
 */
@TableName("Basin_Flow_24Hour_Forecast")
@ApiModel(value="BasinFlow24hourForecast对象", description="")
public class BasinFlow24hourForecastDto implements Serializable{
    ...
    public String toString() {
        return "BasinFlow24hourForecast{" +
        "ldate=" + ldate +
        ", b1=" + b1 +
        ", b2=" + b2 +
        ", b3=" + b3 +
