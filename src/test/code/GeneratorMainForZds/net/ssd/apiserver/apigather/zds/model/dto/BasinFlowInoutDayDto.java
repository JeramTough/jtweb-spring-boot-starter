 ...
 * @since 2021-03-08
 */
@TableName("Basin_Flow_inout_day")
@ApiModel(value="BasinFlowInoutDay对象", description="")
public class BasinFlowInoutDayDto implements Serializable{
