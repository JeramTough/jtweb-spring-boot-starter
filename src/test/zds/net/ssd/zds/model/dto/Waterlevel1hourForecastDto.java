 ...
 * @since 2021-04-25
 */
@TableName("WaterLevel_1Hour_Forecast")
@ApiModel(value="Waterlevel1hourForecast对象", description="")
public class Waterlevel1hourForecastDto implements Serializable{
    ...
    public String toString() {
        return "Waterlevel1hourForecast{" +
        "ldate=" + ldate +
        ", ltime=" + ltime +
        ", b1=" + b1 +
        ", b2=" + b2 +
