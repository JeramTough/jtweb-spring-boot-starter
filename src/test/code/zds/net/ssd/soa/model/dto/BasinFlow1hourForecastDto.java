 ...
 * @since 2021-08-24
 */
@TableName("Basin_Flow_1Hour_Forecast")
@ApiModel(value="BasinFlow1hourForecast对象", description="")
public class BasinFlow1hourForecastDto implements Serializable{
