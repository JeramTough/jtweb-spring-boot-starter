 ...
 * </pre>
 */
public class GeneratorMainForSsdComponent {
    ...
    public static void main(String[] args) {
        CodeGeneratorAgent codeGeneratorAgent = new CodeGeneratorAgent(new GeneratorConfigAdapter() {
            ...
            public String getOutputDir() {
                return "E:\\Codes\\IdeaCodes\\spring-boot-starter-jtweb2\\src\\test\\GeneratorMainForSsdComponent";
            }
            ...
            public String getUrl() {
                return "jdbc:mysql://192.168.0.213:3306/SSD_COMPONENT?useUnicode=true" +
