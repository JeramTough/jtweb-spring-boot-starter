 ...
 * @since 2021-03-08
 */
@TableName("Basin_Flow_inout_old")
@ApiModel(value="BasinFlowInoutOld对象", description="")
public class BasinFlowInoutOldDto implements Serializable{
