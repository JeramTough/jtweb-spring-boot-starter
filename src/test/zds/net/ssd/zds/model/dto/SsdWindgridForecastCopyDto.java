 ...
 * @since 2021-04-25
 */
@TableName("ssd_windGrid_forecast_copy")
@ApiModel(value="SsdWindgridForecastCopy对象", description="")
public class SsdWindgridForecastCopyDto implements Serializable{
    ...
    public String toString() {
        return "SsdWindgridForecastCopy{" +
        "id=" + id +
        ", windU=" + windU +
        ", windV=" + windV +
        ", lon=" + lon +
