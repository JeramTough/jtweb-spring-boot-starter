 ...
 * @since 2021-08-24
 */
@TableName("city_Hydropower_day")
@ApiModel(value="CityHydropowerDay对象", description="")
public class CityHydropowerDayDto implements Serializable{
